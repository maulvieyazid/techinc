...
Route::get('/registrasi', 'WelcomeController@registrasi')->name('all.registrasi');
Route::get('/registrasi/{registrasi}', 'WelcomeController@detailRegistrasi')->name('detail.registrasi');
Route::get('/join', 'WelcomeController@join')->name('join');
