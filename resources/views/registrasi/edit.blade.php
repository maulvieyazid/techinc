                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="{{ route('registrasi.update', $registrasi->slug) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="judul" class="form-control" name="judul"
                                                    placeholder="Judul" value="{{ $registrasi->judul }}" required
                                                    autofocus>
                                            </div>
                                            <div class="col-md-2">
    ...
    @push('scripts')
        ...
        <script>
            ...
            flatpickr('#tanggal_mulai', {
                ...
                enableTime: false,
                dateFormat: "Y-m-d",
                defaultDate: "{{ $registrasi->tanggal_mulai }}",
                locale: 'id',
            })
            ...
            flatpickr('#tanggal_selesai', {
                ...
                enableTime: false,
                dateFormat: "Y-m-d",
                defaultDate: "{{ $registrasi->tanggal_selesai }}",
                locale: 'id',
            })
        </script>
    @endpush
