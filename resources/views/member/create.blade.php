                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('member.store') }}"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" class="form-control" name="member[0][nama_member]"
                                            ...
                                            <div class="col-md-5 form-group">
                                                <input class="form-control" type="file" name="member[0][foto]"
            ...
            function addItem() {
                ...
                document.getElementById("added_item").insertAdjacentHTML('beforeend',
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-10 form-group">
                            <input type="text" class="form-control" name="member[${countItem}][nama_member]"
                                placeholder="Nama" required autofocus>
                        </div>
                        ...
                        <div class="col-md-5 form-group">
                            <input class="form-control" type="file" name="member[${countItem}][foto]"
