            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex justify-content-end">
                            <a href="{{ route('tim-startup.create') }}" class="btn btn-primary ">
                ...
                <div class="card-body">
                    <table class="table table-striped table-responsive" id="table_master">
                        ...
                        <tbody>
                            @foreach ($semuaTimStartup as $timStartup)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $timStartup->nama }}</td>
                                    <td>{{ $timStartup->posisi }}</td>
                                    <td>
                                        ...
                                        <div class="btn-group dropstart  mb-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('tim-startup.show', $timStartup->id_tim) }}">
                                                    <i class="bi bi-eye-fill me-50"></i> Lihat
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ route('tim-startup.edit', $timStartup->id_tim) }}">
