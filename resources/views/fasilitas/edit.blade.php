                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST"
                                    action="{{ route('fasilitas.update', $fasilitas->id_fasilitas) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-11 form-group">
                                                <input type="number" class="form-control" name="urutan"
                                                    value="{{ $fasilitas->urutan }}" placeholder="Urutan" min="0"
                                            ...
                                            <div class="col-md-11 form-group">
                                                <input type="text" class="form-control" name="nama_fasilitas"
                                                    value="{{ $fasilitas->nama_fasilitas }}" placeholder="Fasilitas" required>
                                            </div>
