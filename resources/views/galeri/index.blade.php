                        ...
                        <tbody>
                            @foreach ($semuaGaleri as $galeri)
                                <tr>
                                    ...
                                    <td>{{ $galeri->nama_file }}</td>
                                    <td>
                                        @if ($galeri->tipe == 1)
                                            <video width="100" height="100" src="{{ asset($galeri->file_galeri) }}">
                                            </video>
                                        @elseif ($galeri->tipe == 2)
                                            <img src="{{ asset($galeri->file_galeri ?? 'images/no-photos.webp') }}" width="100"
                                                height="100">
                                        @endif
                                    </td>
                                        ...
                                        <div class="btn-group dropstart  mb-1">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href=""
                                                    onclick="event.preventDefault(); hapus(this, '{{ $galeri->nama_file }}')">
