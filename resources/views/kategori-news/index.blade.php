                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex justify-content-end">
                            <a href="{{ route('kategori-news.create') }}" class="btn btn-primary ">
                        ...
                        <tbody>
                            @foreach ($semuaKategoriNews as $kategoriNews)
                                <tr>
                                    ...
                                    <td>{{ $kategoriNews->nama_kategori }}</td>
                                    <td>{{ $kategoriNews->created_at->translatedFormat('l, d F Y H:i:s') }}</td>
                                    <td>
                                        <div class="btn-group dropstart  mb-1">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href=""
                                                    onclick="event.preventDefault(); hapus(this, '{{ $kategoriNews->nama_kategori }}')">
                                                    <i class="bi bi-trash-fill me-50"></i> Hapus
                                                    <form action="{{ route('kategori-news.destroy', $kategoriNews->slug) }}"
        ...
        <script>
            ...
            async function hapus(btn, item) {
                ...
                const {
                    ...
                    icon: "warning",
                    title: "Peringatan",
                    html: `<h3 style='color:red'>Jika anda menghapus Kategori News maka seluruh News yang ada di dalam Kategori tersebut juga akan terhapus.</h3><h5>Apakah anda yakin ingin menghapus ${item}?</h5>`,
