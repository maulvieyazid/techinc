                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('carousel-image.store') }}"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="number" class="form-control" name="carousel[0][urutan]"
                                            ...
                                            <div class="col-md-5 form-group">
                                                <input class="form-control" type="file" name="carousel[0][foto]"
            ...
            function addItem() {
                ...
                document.getElementById("added_item").insertAdjacentHTML('beforeend',
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-10 form-group">
                            <input type="number" class="form-control" name="carousel[${countItem}][urutan]"
                                placeholder="Urutan" min="0" oninput="this.value =
                                !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" required autofocus>
                        </div>
                        ...
                        <div class="col-md-5 form-group">
                            <input class="form-control" type="file" name="carousel[${countItem}][foto]"
